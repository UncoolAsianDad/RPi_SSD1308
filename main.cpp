...
int main ()
{
	while(1) {
		string line1 = "RPI ";
		line1.append(GetStdoutFromCommand("awk '{print $3}' /proc/version")); // kernel release
		oled.writeString(0, 0, (char*)line1.c_str());
		...
		line7.append("M");
		oled.writeString(5, 0, (char*)line7.c_str());

		string line8 = GetStdoutFromCommand("ip -o -4 addr | awk '!/^[0-9]*: ?lo|link\\/ether/ {print $4}'"); // IP address
		oled.writeString(6, 0, (char*)line8.c_str());
